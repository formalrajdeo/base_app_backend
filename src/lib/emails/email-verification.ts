  ...
  await sendEmail({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>Hello ${user.name},</p>
        <p>We received a request to verify your email address. Please click the button below to complete the verification:</p>
        <a href="${url}" style="background-color: #28a745; color: white; padding: 12px 24px; text-decoration: none; border-radius: 4px; display: inline-block; margin: 16px 0;">Verify Email</a>
    ...
    `,
    text: `Hello ${user.name},\n\nWe received a request to verify your email address. Please verify your email by clicking this link: ${url}\n\nIf you didn't request this, you can ignore this email.\n\nThis link will expire in 24 hours.\n\nBest regards,\nYour App Team`,
  })
}